  ...
  <body>
    ...
    <div class="video-container vertical-center">
      <div class="front absolute card col-xs-12">
				<CENTER><h3 class="white-text">Seleccione producto a modificar</h3></CENTER>
        ...
        <br><input type="text" class="form-control" id="nombre" value="" placeholder="Escribe el nombre del producto "><br>
        ...
        <button type="button" class="form-control" id="guardar">Modificar producto</button>
      </div>
    </div>
        ...
        let producto = new Producto(nombre.value,precio.value,categoria.value,descripcion.value);
				...
				$.ajax({
				  ...
				  url: "./../controllers/ProductsController.php",
					data: { productos: arregloJSON, funcion: "modificarProductos" , idProd:idProd.value}
				})
				.done(function() {
